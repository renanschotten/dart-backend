...
class BlogApi {
  ...
  Handler get handler {
    ...
    //Listagem
    router.get('/api/v1/blog/noticias', (Request req) {
    ...
    //Nova notícia
    router.post('/api/v1/blog/noticias', (Request req) async {
    ...
    //Atualização
    router.put('/api/v1/blog/noticias', (Request req) {
    ...
    //Exclusão
    router.delete('/api/v1/blog/noticias', (Request req) {
      String? id = req.url.queryParameters['id'];
